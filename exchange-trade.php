...
<!-- Stylesheet -->
<link rel="stylesheet" href="css/exchange-trade.css">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="balance">CHANGE</th>
                                        <th class="balance">MARKET CAP</th>
                                        <th class="balance"></th>
                                        <th class="balance">WATCH</th>
                                    </tr>
                                </thead>
                                <tr>
                                    <td class="name">
                                    ...
                                    <td class="balance">
                                        <a href="#" class="btn">Buy <i class="fa fa-arrow-right"></i></a>
                                    </td>
                                    <td class="balance">
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        ...
                        <div class="payment-card-wrapper">
                            <div class="img-wrapper">
                                <figure>
                                    <img src="img/payemt-icon.png" class="img-fluid" alt="">
                                </figure>
                            </div>
                            <div class="content-wrapper">
                                <h4>You're almost ready to buy.
                                    Please complete your account</h4>
                                <p>To make an investment, please add a payment method</p>
                                <div class="btn-wrapper">
                                    <a href="#" class="btn">Add A Payment Method <i class="fa fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="recent-wrapper">
                            ...
                            <a class="btn" href="#">Trade <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>

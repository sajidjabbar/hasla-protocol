        ...
        <div class="row">
            ...
            <div style="padding-left: 20px !important;" class="col-lg-6 ii px-0">
                ...
                <div class="earn-wrapper">
                    ...
                    <div class="learn-yeld-wrapper">
                        <div class="img-wrapper">
                            <figure>
                                <img src="img/brain.png" class="img-fluid" alt="">
                            </figure>
                        </div>
                        <div class="yeild-content-wrapper">
                            <h6>Learn about yield</h6>
                ...
                <div class="discovery-assets-wrapper">
                    <div class="disccovery-heading-wrapper">
                        <h4>Discover new assets</h4>
                        <p>Earn yield by holding these assets on coinbase</p>
                    </div>
                    <div class="discovery-row-wrapper">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="discovery-card-wrapper">
                                    ...
                                    <div class="dixcovery-content-wrapper">
                                        <h4>Ethereum 2 </h4>
                                        <h3>3.92% <span>APY</span></h3>

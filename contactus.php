                ...
                <div class="page-header-wrapper">
                    ...
                    <div class="breadcrumbs-wrapper">
                        <ul>
                            ...
                            <li class="current-page"><a href="#">Contact us</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="content-wrapper">
                    ...
                    <p>
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.Lorem Ipsum is simply dummy text of the printing and
                    </p>
            ...
            <div class="col-lg-8">
                <div class="form-wrapper">
                    <form action="">
                        ...
                        <div class="form-group">
                            <textarea name="" placeholder="Message" class="form-control" id="" cols="30" rows="6"></textarea>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-8">

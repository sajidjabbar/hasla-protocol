    ...
    <div class="container">
        <div class="crypto-box">
            ...
            <div class="for-tabs">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-assets-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-assets" type="button" role="tab" aria-controls="pills-assets"
                            aria-selected="true"><img src="img/tade-icon.png" alt="123" class="img-fluid" /> All
                            Assets</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-tardeable-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-tardeable" type="button" role="tab" aria-controls="pills-tardeable"
                            aria-selected="false"><img src="img/tade-icon.png" alt="123" class="img-fluid" />
                            Tradable</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-gainers-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-gainers" type="button" role="tab" aria-controls="pills-gainers"
                            aria-selected="false"><img src="img/tade-icon.png" alt="123" class="img-fluid" />
                            Gainers</button>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-assets" role="tabpanel"
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="trade">
                                        <button>Trade <span><svg xmlns="http://www.w3.org/2000/svg" width="9.138"
                                                    height="8.908" viewBox="0 0 9.138 8.908">
                                                    <path id="Icon_awesome-arrow-right"
                                                        data-name="Icon awesome-arrow-right"
                                                        d="M3.886,3.24l.453-.453a.488.488,0,0,1,.692,0L8.995,6.75a.488.488,0,0,1,0,.692L5.03,11.408a.488.488,0,0,1-.692,0l-.453-.452a.49.49,0,0,1,.008-.7L6.353,7.914H.49A.488.488,0,0,1,0,7.424V6.772a.488.488,0,0,1,.49-.489H6.353L3.894,3.941a.486.486,0,0,1-.008-.7Z"
